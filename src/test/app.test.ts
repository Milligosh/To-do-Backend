...
describe('Task test', () => {
  ...
  it('should log in a user successfully', async () => {
    ...
    expect(poolQueryStub).to.have.been.calledOnceWith(userQueries.fetchUserByEmail, [body.email]);
    expect(bcryptCompareSyncStub).to.have.been.calledOnceWith(body.password, user.password);
  ...
  it('should fail to create a new user when username already exists', async () => {
    ...
    expect(poolQueryStub.firstCall).to.have.been.calledWith(userQueries.fetchUserByEmail, [body.email]);
    expect(poolQueryStub.secondCall).to.have.been.calledWith(userQueries.fetchUserByUsername, [body.userName]);
  });
  ...
  it('should create a new task successfully', async () => {
    ...
    expect(poolQueryStub).to.have.been.calledOnceWith(taskQueries.createTask, [body.userId, body.task, body.priority]);
  });
  ...
  it('should successfully delete a task', async () => {
    ...
    expect(poolQueryStub).to.have.been.calledTwice;
    expect(poolQueryStub.firstCall).to.have.been.calledWith(taskQueries.fetchTaskbyId, [taskId]);
    expect(poolQueryStub.secondCall).to.have.been.calledWith(taskQueries.deleteTask, [taskId]);
  });
  ...
  it('should fail to delete a task that does not exist', async () => {
    ...
    expect(poolQueryStub).to.have.been.calledOnceWith(taskQueries.fetchTaskbyId, [taskId]);
  });
